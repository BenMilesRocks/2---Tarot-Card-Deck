...
function turnSound(){
    const slideSound = new Audio("audio/card-slide.mp3");
    slideSound.play();
} 
...
function displayCard(inverted){
    ...
    cardBack.src = "images/card-back.jpg";
...
function toggleZoom(image){
    ...
    const pickUp = new Audio("audio/pick-up-card.mp3")
    pickUp.play();
...
function playShuffledCardSound(){
    const shuffleAudio = new Audio("audio/cards-shuffle.mp3");
    shuffleAudio.play();
}
